...
$query = 'SELECT E.customerID, E.emailAddress, E.firstName, E.lastName, A.line1, A.city, A.state, A.zipCode, A.phone FROM customers E
INNER JOIN addresses A
ON E.customerID = A.customerID
GROUP BY  E.customerID, E.emailAddress, E.firstName, E.lastName, A.line1, A.city, A.state, A.zipCode, A.phone';// PUT YOUR SQL QUERY HERE
